...
class SweetAlertV2DialogState extends State<SweetAlertV2Dialog>
  ...
  Widget build(BuildContext context) {
    ...
    if (_options.style != SweetAlertV2Style.loading &&
        _options.confirmButtonText?.isEmpty == false) {
              ...
              return new ScaleTransition(
                ...
                child: new ClipRRect(
                  borderRadius: new BorderRadius.all(
                      new Radius.circular(_options.boxRadius)),
                  child: new Container(
                      color: Colors.white,
                      width: double.infinity,
                      child: new Padding(
                        padding: new EdgeInsets.fromLTRB(
                            0.0, _options.paddingV, 0.0, _options.paddingV),
                        child: new Column(
...
abstract class SweetAlertV2 {
  ...
  static void show(BuildContext context,
    ...
    if (paddingV != null) {
      options.paddingV = paddingV;
    }
    if (marginL != null) {
      options.marginL = marginL;
    }
    if (boxRadius != null) {
      options.boxRadius = boxRadius;
    }
      ...
      showDialog(
          ...
          builder: (BuildContext context) {
            return new Container(
              ...
              child: new Padding(
                padding: EdgeInsets.symmetric(horizontal: options.marginL),
                child: new Scaffold(
