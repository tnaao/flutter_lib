    ...
    FlutterWebView(
        ...
        webView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                if (null == result) {
                    Log.e(getClass().getSimpleName(), "long click failed");
                    return false;
                }
                ...
                Log.i(getClass().getSimpleName(), "check current type:" + type);
                if (WebView.HitTestResult.IMAGE_TYPE == type) {
                    Log.i(getClass().getSimpleName(), "long click image:" + result.getExtra());
                    if (result.getExtra() != null && result.getExtra().startsWith("http")) {
                        Map<String, Object> args = new HashMap<>();
                        args.put("url", result.getExtra());
                        methodChannel.invokeMethod("onImageLongPress", args);
                    }
                }
                return true;
            }
        ...
        if (params.containsKey("initialContent")) {
            String content = (String) params.get("initialContent");

            if (content != null)
                webView.loadDataWithBaseURL((String) params.get("initialHost"), content, "text/html", "utf-8", null);
        }


        if (params.containsKey("userInteractive")) {
            Boolean userInteractive = (Boolean) params.get("userInteractive");
            ...
            if (!userInteractive) {
                webView.setOnTouchListener(new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        Log.e(getClass().getSimpleName(), "not touchable");
                        return true;
                    }
                });
