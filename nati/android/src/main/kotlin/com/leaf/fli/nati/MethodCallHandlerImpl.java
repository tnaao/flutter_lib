 ...
 */
public final class MethodCallHandlerImpl implements MethodCallHandler, PluginRegistry.ActivityResultListener {
    ...
    void startListening(BinaryMessenger messenger) {
        ...
        methodChannel = new MethodChannel(messenger, NatiPlugin.CHANNEL_NAME);
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        ...
        Intent intent = sender.buildIntent(action, flags, category, data, arguments, packageName, componentName, type);
