...
class AgoraRtmClient {
  ...
  static Future<AgoraRtmClient> createInstance(String appId) async {
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "Create client failed errorCode:${res['errorCode']},msg:${res['errorDescription']},msg:${res['errorDescription']}",
          res['errorCode']);
  ...
  static Future<String> getSdkVersion() async {
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "getSdkVersion failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
    return res["version"];
  }
  ...
  void Function(dynamic onlineStatus)? onPeersOnlineStatusChanged;
  ...
  void Function(AgoraRtmLocalInvitation invite, int errorCode,
      String errorDescription)? onLocalInvitationFailure;
  ...
  _eventListener(dynamic event) {
    ...
    switch (map['event']) {
      ...
      case 'onPeersOnlineStatusChanged':
        this.onPeersOnlineStatusChanged?.call(map['onlineStatus']);
        break;
  ...
  Future setLog(int level, int size, String path) async {
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "login failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
    return res["result"];
  }
  ...
  Future login(String? token, String userId) async {
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "login failed errorCode:${res['errorCode']},msg:${res['errorDescription']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<dynamic> logout() async {
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "logout failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
    return res;
  }

  Future xRelease() async {
    final res = await _callNative("logout", null);
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "logout failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
  ...
  Future renewToken(String token) async {
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "renewToken failed errorCode:${res['errorCode']},msg:${res['errorDescription']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<Map<String, dynamic>> queryPeersOnlineStatus(
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "queryPeersOnlineStatus failed errorCode:${res['errorCode']},msg:${res['errorDescription']},msg:${res['errorDescription']}",
          res['errorCode']);
    return Map<String, dynamic>.from(res["results"]);
  }

  Future<void> subscribePeersOnlineStatus(List<String> peerIds) async {
    final res =
        await _callNative("subscribePeersOnlineStatus", {'peerIds': peerIds});
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "subscribePeersOnlineStatus failed errorCode:${res['errorCode']},msg:${res['errorDescription']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<void> sendMessageToPeer(String peerId, AgoraRtmMessage message,
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "sendMessageToPeer failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<void> setLocalUserAttributes(
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "setLocalUserAttributes failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<void> addOrUpdateLocalUserAttributes(
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "addOrUpdateLocalUserAttributes failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<void> deleteLocalUserAttributesByKeys(List<String> keys) async {
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "deleteLocalUserAttributesByKeys failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<void> clearLocalUserAttributes() async {
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "clearLocalUserAttributes failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<Map<String, dynamic>> getUserAttributes(String userId) async {
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "getUserAttributes failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  ...
  Future<Map<String, dynamic>> getUserAttributesByKeys(
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "getUserAttributesByKeys failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
    return Map<String, dynamic>.from(res["attributes"]);
  }
  ...
  Future<void> setChannelAttributes(
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "setChannelAttributes failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<void> addOrUpdateChannelAttributes(
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "addOrUpdateChannelAttributes failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<void> deleteChannelAttributesByKeys(String channelId,
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "deleteChannelAttributesByKeys failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<void> clearChannelAttributes(
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "clearChannelAttributes failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<List<AgoraRtmChannelAttribute>> getChannelAttributes(
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "getChannelAttributes failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  ...
  Future<List<AgoraRtmChannelAttribute>> getChannelAttributesByKeys(
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "getChannelAttributesByKeys failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
    return List<Map<dynamic, dynamic>>.from(res["attributes"])
        .map((attr) => AgoraRtmChannelAttribute.fromJson(attr))
        .toList();
  ...
  Future<void> sendLocalInvitation(Map<dynamic, dynamic> arguments) async {
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "sendLocalInvitation failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<void> cancelLocalInvitation(Map<dynamic, dynamic> arguments) async {
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "cancelLocalInvitation failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<void> acceptRemoteInvitation(Map<dynamic, dynamic> arguments) async {
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "acceptRemoteInvitation failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<void> refuseRemoteInvitation(Map<dynamic, dynamic> arguments) async {
    ...
    if (res["errorCode"] != 0)
      throw AgoraRtmClientException(
          "refuseRemoteInvitation failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  }
  ...
  Future<AgoraRtmChannel?> createChannel(String channelId) async {
    ...
    if (res['errorCode'] != 0)
      throw AgoraRtmClientException(
          "createChannel failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
  ...
  Future<void> releaseChannel(String channelId) async {
    ...
    if (res['errorCode'] != 0)
      throw AgoraRtmClientException(
          "releaseChannel failed errorCode:${res['errorCode']},msg:${res['errorDescription']}",
          res['errorCode']);
