...
typedef void PageOnImageLongPress(String url);
...
class WebView extends StatefulWidget {
  ...
  final PageOnImageLongPress? onImageLongPress;
...
CreationParams _creationParamsfromWidget(WebView widget) {
  return CreationParams(
    ...
    userInteractive: widget.userInteractive,
...
class _PlatformCallbacksHandler implements WebViewPlatformCallbacksHandler {
  ...
  @override
  void onImageLongPress(String url) {
    if (_widget.onImageLongPress != null) {
      _widget.onImageLongPress!(url);
    }
  }
