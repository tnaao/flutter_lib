...
public class DownloadTaskBuilder {
    ...
    public DownloadTaskBuilder setSavePath(final String savePath) {
    ...
    public DownloadTask build() {
        if (task == null)
            task = new DownloadTask(instance.activity, instance.url, instance.name, instance.savePath, callbacks);
        try {
